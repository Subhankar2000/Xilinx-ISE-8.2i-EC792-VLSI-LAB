...
dll0 : CLKDLL port map (CLKIN => Clk, CLKFB => Clk_FB, RST => Reset_i, CLK0 => unused1,
	       		CLK90 => OPEN, CLK180 => OPEN, CLK270 => OPEN, CLK2X => Clk0A, 
			CLKDV => unused2, LOCKED => Locked1);
...
dll1 : CLKDLL port map (CLKIN => Clk, CLKFB => Clk_i, RST => Reset_i, CLK0 => Clk0C,
	       		CLK90 => OPEN, CLK180 => OPEN, CLK270 => OPEN, CLK2X => Clk0B, 
			CLKDV => unused3, LOCKED => Locked2);
