...
/**********************************************************************\
*                                                                      *
* Module      : tb_x258v_ic1.v                Last updated: 07/14/00   *
*                                                                      *
...
reg GSR;
`define GSR_SIGNAL tb_ic1_func.GSR
...
initial begin
   ...
   write_enable = 0;
   write_data = 'h0;
   tb_ic1_func.fifo_controller.read_addr = 'h0;
   tb_ic1_func.fifo_controller.read_nextgray = 'b100000000;
   tb_ic1_func.fifo_controller.read_addrgray = 'b100000001;
   tb_ic1_func.fifo_controller.read_lastgray = 'b100000011;
   tb_ic1_func.fifo_controller.read_truegray = 'h0;
   tb_ic1_func.fifo_controller.rag_writesync = 'h0;
   tb_ic1_func.fifo_controller.write_addr = 'h0;
   tb_ic1_func.fifo_controller.write_nextgray = 'b100000000;
   tb_ic1_func.fifo_controller.write_addrgray = 'b100000001;
   tb_ic1_func.fifo_controller.fifostatus = 'h0;
   tb_ic1_func.fifo_controller.full = 'b1;
   tb_ic1_func.fifo_controller.empty = 'b1;
   GSR = 1;
   #83 GSR = 0;
   ...
   $monitor(" %10.2f  %b  %b %3x %9x  %b  %b %3x %9x  %b %b %3x %3x %3x %3x %3x %3x %b%b %3x %3x %3x",
             ...
             tb_ic1_func.fifo_controller.read_addr, read_data, 
             write_clockin, write_enable, 
             tb_ic1_func.fifo_controller.write_addr, write_data,
             tb_ic1_func.fifo_controller.full,
             tb_ic1_func.fifo_controller.empty,
             tb_ic1_func.fifo_controller.fifostatus,
             tb_ic1_func.fifo_controller.read_nextgray,
             tb_ic1_func.fifo_controller.read_addrgray,
             tb_ic1_func.fifo_controller.read_lastgray,
             tb_ic1_func.fifo_controller.write_nextgray,
             tb_ic1_func.fifo_controller.write_addrgray,
             tb_ic1_func.fifo_controller.emptyg,
             tb_ic1_func.fifo_controller.fullg,
             tb_ic1_func.fifo_controller.read_truegray,
             tb_ic1_func.fifo_controller.ra_writesync,
             tb_ic1_func.fifo_controller.write_addrr
             );
end
