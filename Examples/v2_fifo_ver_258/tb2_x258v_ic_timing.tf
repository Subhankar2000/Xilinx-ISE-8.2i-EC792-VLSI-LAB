...
/**********************************************************************\
*                                                                      *
* Module      : fifoctrl_ic_tb2.v             Last updated: 06/04/03   *
*                                                                      *
...
reg GSR;
`define GSR_SIGNAL tb_ic2_time.GSR
...
initial begin
   ...
   write_enable = 0;
   write_data = 'h0;
/* commented out for timing simulation
   tb_ic2_time.fifoctlr_ic.read_addr = 'h0;
   tb_ic2_time.fifoctlr_ic.read_nextgray = 'b100000000;
   tb_ic2_time.fifoctlr_ic.read_addrgray = 'b100000001;
   tb_ic2_time.fifoctlr_ic.read_lastgray = 'b100000011;
   tb_ic2_time.fifoctlr_ic.read_truegray = 'h0;
   tb_ic2_time.fifoctlr_ic.rag_writesync = 'h0;
   tb_ic2_time.fifoctlr_ic.write_addr = 'h0;
   tb_ic2_time.fifoctlr_ic.write_addrr = 'h0;
   tb_ic2_time.fifoctlr_ic.write_nextgray = 'b100000000;
   tb_ic2_time.fifoctlr_ic.write_addrgray = 'b100000001;
   tb_ic2_time.fifoctlr_ic.fifostatus = 'h0;
   tb_ic2_time.fifoctlr_ic.full = 'b1;
   tb_ic2_time.fifoctlr_ic.empty = 'b1;
*/
...
/* Commented out for Timing simulation
   ...
   $monitor(" %10.2f  %b  %b %3x %2x  %b  %b %3x %3x  %b %b %3x %3x %3x %3x %3x %3x %b%b %3x %3x %3x",
             ...
             tb_ic2_time.fifoctlr_ic.read_addr, read_data, 
             write_clockin, write_enable, 
             tb_ic2_time.fifoctlr_ic.write_addr, write_data,
             tb_ic2_time.fifoctlr_ic.full,
             tb_ic2_time.fifoctlr_ic.empty,
             tb_ic2_time.fifoctlr_ic.fifostatus,
             tb_ic2_time.fifoctlr_ic.read_nextgray,
             tb_ic2_time.fifoctlr_ic.read_addrgray,
             tb_ic2_time.fifoctlr_ic.read_lastgray,
             tb_ic2_time.fifoctlr_ic.write_nextgray,
             tb_ic2_time.fifoctlr_ic.write_addrgray,
             tb_ic2_time.fifoctlr_ic.emptyg,
             tb_ic2_time.fifoctlr_ic.fullg,
             tb_ic2_time.fifoctlr_ic.read_truegray,
             tb_ic2_time.fifoctlr_ic.ra_writesync,
             tb_ic2_time.fifoctlr_ic.write_addrr
             );*/
end
