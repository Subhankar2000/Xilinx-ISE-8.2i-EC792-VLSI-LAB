...
*      Version:  1.11
*         Date:  June 2, 1999
*  Description:  functional testbench for SDRAM controller
* Dependencies:  mt48lc2m8a1-8, sdrm
*
*      Company:  Xilinx
*
*
...
module f_sdrm;
   ...
   initial begin
      //$vcdpluson;  //generate waveform file for virsim
      $monitor($time,, "%b", clk, ras_n, cas_n, we_n, ba, addr, DQ );
      begin	
	 force f_sdrm.sdrmc.sdrm_t.sdrm_st.state = 13'b0000000000001;
	 #(`CYCLE);
	 release f_sdrm.sdrmc.sdrm_t.sdrm_st.state;
	
	 nop ;                                       // Nop
	 #( 86* `CYCLE +1); addr_wr (32'h20340400);  // Precharge, load Controller MR
